...
const planets = [
  {
    ...
    size: 90,
    story: "في 6 أغسطس، جالك أول رسالة مني.. كنت قاعد مش عارف هتكون بداية حكاية عمري. كل كلمة بينّا كانت زي قطرة مطر بتسقي قلبي. ده الكوكب اللي كل حاجة بدأت منه 🌍",
    emoji: "🌍",
  },
  {
    id: "venus",
    ...
    size: 70,
    story: "بدأنا نتكلم كل يوم.. كل تفصيلة، كل ضحكة، كل ذكرى. عرفت إن في حد بقى أهم من النوم، وأهم من الأكل، وأهم من أي حاجة في الدنيا 💛",
    emoji: "🪐",
  },
  {
    id: "moon",
    ...
    size: 80,
    story: "اليوم اللي قلنا فيه 'إحنا مع بعض'. اليوم اللي كل النجوم وقفت تشاهدنا. صرنا واحد، وصرت أعرف معنى البيت اللي عمره ما يبعد عنّي 💍",
    emoji: "🌙",
  },
  {
    id: "mars",
    ...
    size: 100,
    story: "الساعة 2 و8 دقائق.. لحظة اتغير فيها كل شيء. لما شفتك قدامي لأول مرة، الدنيا وقفت ثانية وقلبي قال 'أنا في البيت'. ده الكوكب اللي مش هينساه قلبي 💋",
    emoji: "❤️",
  },
  {
    id: "saturn",
    ...
    size: 95,
    story: "كل خروجة، كل ضحكة، كل مشاجرة صغيرة وصلح، كل هدية، كل صورة.. كلها محفوظة في حلقات هذا الكوكب الذهبي 🪐",
    emoji: "🪐",
  },
  {
    id: "future",
    ...
    size: 110,
    story: "الكوكب اللي لسه ما زرناهوش.. اللي فيه بيتنا، أطفالنا، رحلاتنا، كل الأحلام اللي قلنا هنحققها سوا. ده الكوكب اللي عمره ما هيخلص ✨",
    emoji: "💫",
  },
];

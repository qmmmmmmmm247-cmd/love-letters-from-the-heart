...
const planets = [
  ...
  },
  {
    id: "sad",
    name: "لو زعلانة مني",
    period: "الكوكب اللي مش بنحب نزوره",
    color: "from-slate-500 to-indigo-600",
    glow: "oklch(0.45 0.15 270)",
    size: 105,
    story: "ده بقى الكوكب اللي مش بحب نزوره خالص، علشان عمري ما حبيت يكون بينا زعل يا بنوتي. عمري ما قدرت على زعلك يا روحي وانتي عارفة. ولو جيتي في يوم وفتحتي الرسالة دي واحنا زعلانين، عايزك تخزي الشيطان كده وأي تفكير سلبي يا روحي. وتعرفي إني مهما سبتك لوقت طويل من غير ما أراضيكي، اعرفي والله مهاين عليا. ولو لقيتيني بارد في الصلح، ممكن تلاقي جوايا زعل برضو، بس عايزك تفتكري إننا ملناش غير بعض في الدنيا. بحبك ينور عيني 💗",
    emoji: "💙",
  },
];

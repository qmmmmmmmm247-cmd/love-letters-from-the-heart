...
const events = [
  { date: "6 أغسطس 2025", emoji: "💬", title: "أول رسالة", desc: "بداية كل شيء.. أول كلمة وصلتني منك وغيرت كل حياتي" },
  { date: "أغسطس - سبتمبر 2025", emoji: "🌸", title: "نتعرف على بعض", desc: "كل يوم بنكتشف حاجة جديدة عن بعض. الكلام مكنش بيخلص" },
  { date: "أكتوبر 2025", emoji: "✨", title: "أول هدية", desc: "أول حاجة بعتهالك.. كانت صغيرة بس كانت من كل قلبي" },
  { date: "نوفمبر 2025", emoji: "💝", title: "ابتدينا نحس", desc: "الكلام بقى أعمق، والإحساس بقى أوضح. مش صدفة كل ده" },
  { date: "1 فبراير 2025", emoji: "💍", title: "يوم الارتباط", desc: "اليوم اللي قلنا فيه إحنا مع بعض. صرنا واحد رسمياً" },
  { date: "مارس 2026", emoji: "📱", title: "مكالمات لا تنتهي", desc: "بنتكلم لحد الصبح.. كل ليلة وكأنها أول مرة" },
  { date: "23 أبريل 2026 - 2:08 ص", emoji: "💋", title: "أول لقاء", desc: "اللحظة اللي شفتك فيها لأول مرة. مفيش كلام يوصف اللحظة دي" },
  { date: "بكرة", emoji: "💫", title: "كل اللي جاي", desc: "حياة كاملة من الذكريات اللي لسه هنعيشها سوا" },
];
